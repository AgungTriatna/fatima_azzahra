...
window.addEventListener("load", () => {
  Swal.fire({
    title: "Mau putar musik pengiring di background?",
...
const animationTimeline = () => {
  ...
  tl.to(".container", 0.8, {
    ...
    .to(".idea-1", 0.9, ideaTextTransLeave, "+=3")
    .from(".idea-2", 0.9, ideaTextTrans)
    .to(".idea-2", 0.9, ideaTextTransLeave, "+=3")
    ...
    .to(".idea-3", 0.9, ideaTextTransLeave, "+=3")
    .from(".idea-4", 0.9, ideaTextTrans)
    .to(".idea-4", 0.9, ideaTextTransLeave, "+=3")
    .from(
      ".idea-5",
      0.7,
      {
